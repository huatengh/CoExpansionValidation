...
#'
#' @param obs A data frame containing the BayeSSC simulated stats
#' @param hbayessclike \code{TRUE} or \code{FALSE}. If \code{TRUE}, directly calculte the hyperstat across all locus in all species. If \code{FALSE}, still need develop
#' @param col A character vector containing the names of columns for hyperstat calculation. Currently this parameter has no use
#'
